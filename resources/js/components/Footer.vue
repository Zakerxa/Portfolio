        ...
        <div class="container">
            ...
            <div class="row justify-content-center" :style="{ 'color': primaryColor }">
                ...
                <div class="col-12 col-md-12 col-lg-4 text-md-start text-lg-center pb-4">
                    ...
                    <p class="fw-bold mb-0">Thanks for visiting my portfolio site.That's all of my Information,Skills
                        ,Contact & services.Come back to me again.</p>
                ...
                <div class="col-12 col-md-6 col-lg-4 text-md-start text-lg-center order-0 order-lg-1 footerSocial pb-4">
                    ...
                    <div class="row justify-content-lg-end fw-bold">
                        ...
                        <div class="col-7 text-start p-0 pl-3">
                            <a class="text-decoration-none text-dark" href="https://goo.gl/maps/ajDihmwUN9zNai4w7"
                                target="_blank">: Myanmar, Yangon</a>
                        </div>
                        <div class="col-3 text-start p-0">
                            <p> Phone </p>
                        </div>
                        ...
                        <div class="col-7 text-start p-0 pl-3">
                            <a class="text-decoration-none text-dark" href="mailto:zakerxa@gmail.com" target="_blank">:
                                zakerxa@gmail.com</a>
                        </div>
                    </div>
                </div>
        ...
        <div class="mapouter">
            <div class="gmap_canvas">
                <iframe width="100%" height="400" id="gmap_canvas"
                    src="https://maps.google.com/maps?q=16.788618,%2096.198985&t=&z=13&ie=UTF8&iwloc=&output=embed"
        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center pt-4 pb-4">
                     Copyright &copy;{{ currentYear }} Zakerxa-Portfolio.All rights reserved.
                </div>
            </div>
        </div>
