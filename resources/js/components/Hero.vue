    ...
    <div class="heroContainer" :style="{ 'background': secondaryBg }">
        ...
        <div class="container pt-4">
            <div class="row justify-content-center align-items-center mt-md-4"
                style="min-height:80vh;overflow-x: hidden; overflow-y: hidden;">
                <div :style="{ 'color': primaryColor }" class="col-12 col-sm-11 col-md-6 col-lg-6 pt-5">
                    ...
                    <div data-aos="fade-left" data-aos-delay="800" class="text-center col-12">
                        <h5 class="p-1 pt-sm-5 pt-md-4 pt-5 fw-bold text-start" style="letter-spacing:0.3px;">
                            I am a backend web developer with over 7 years of experience in PHP, Laravel, and Vue.js. I
                            specialize in building secure, scalable, and user-focused web applications.
                        </h5>
                        <div @click="clickCvForm()" @mouseleave="btnMsg = 'CV Form'" @mouseover="btnMsg = 'Check it'"
                            id="hero-btn">
                            <span>{{ btnMsg }}</span>
                            <div></div>
                        </div>
